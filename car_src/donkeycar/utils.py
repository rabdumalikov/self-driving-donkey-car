...
def get_model_by_type(model_type: str, cfg: 'Config', ctr) -> 'KerasPilot':
    '''
    given the string model_type and the configuration settings in cfg
    create a Keras model and return it.
    '''
    from donkeycar.parts.keras import KerasPilot, KerasCategorical, \
        KerasLinear, KerasInferred, KerasBehavioral
    from donkeycar.parts.CustomLinear import CustomLinear
    from donkeycar.parts.CustomBehavioral import CustomBehavioral
    ...
    elif model_type == "custombehavior":
        kl = CustomBehavioral(num_behavior_inputs=3, input_shape=input_shape,ctr=ctr)
    elif model_type == "customlinear":
        kl = CustomLinear(input_shape=(50,160,3))
